  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        ...
        const clientId = "BPxhvfsM1NJqh3Cvh3jQMC9m0WWaRyffDF0A3YcnS-0IN8g9Kr6VBAqcHibqAULAEimnOv1_Gcy2WPYCJauas_Y";
        setIsLoading(true);
        const web3AuthInstance = new Web3Auth({
          uiConfig: {
            appLogo: "https://www.antiersolutions.com/wp-content/uploads/2021/08/blockchain-revolution-img-min.webp",
            theme: "dark",
